...
ros2 bag play --rate 1 $1 \
              --topics /sensing/camera/c1/image_rect_resized \
                       /localization/pose_twist_fusion_filter/biased_pose_with_covariance \
                       /tf \
                       /tf_static \
              --remap /sensing/camera/c1/image_rect_resized:=image \
                      /localization/pose_twist_fusion_filter/biased_pose_with_covariance:=initial_pose_with_covariance
