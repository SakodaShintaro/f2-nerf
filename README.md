...
```shell
python scripts/run.py --config-name=wanjinyou dataset_path=./data/example/ngp_fox mode=train +work_dir=$(pwd)
```

### Render test images
Simply run:
```shell
python scripts/run.py --config-name=wanjinyou dataset_path=./data/example/ngp_fox mode=test is_continue=true +work_dir=$(pwd)
```
...
```shell
python scripts/run.py --config-name=wanjinyou dataset_path=./data/example/ngp_fox mode=render_path is_continue=true +work_dir=$(pwd)
```
...
dataset_name=<your-dataset-name> mode=train \
+work_dir=$(pwd)
```
